...
class FilmRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pochette' => 'required|image|mimes:png,jpeg,jpg|max:4000',
    ...
    public function message()
    {
        return[
            ...
            'pochette.max' => 'La taille de l\'image est trop grande  (Max: 4000Kb).',
            'pochette.mimes' => 'Le type de fichier n\'est pas reconnu.',
